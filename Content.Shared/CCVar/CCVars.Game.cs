...
public sealed partial class CCVars
{
    ...
    /// </summary>
    public static readonly CVarDef<string>
        GameLobbyDefaultPreset = CVarDef.Create("game.defaultpreset", "ESMasqueradeManaged", CVar.ARCHIVE);
    ...
    /// </summary>
    public static readonly CVarDef<string>
        GameLobbyFallbackPreset = CVarDef.Create("game.fallbackpreset", "ESSandbox", CVar.ARCHIVE);
