...
/// </para>
/// <para>
///     This is a reimplementation of <see cref="ScrollContainer"/> in engine to fix an engine bug with it.
/// </para>
/// </remarks>
[Virtual]
public class Scroll : Container
{
    ...
    public Scroll()
    {
        ...
        Action<Robust.Client.UserInterface.Controls.Range> ev = _scrollValueChanged;
    ...
    private void _scrollValueChanged(Robust.Client.UserInterface.Controls.Range obj)
    {
